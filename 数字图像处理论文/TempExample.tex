...
\input{section/实验结果展示及分析1}

\input{section/实验结果展示与分析2}
...
% \begin{figure}[htbp]
% \centering
% \includegraphics[width=\linewidth,trim=0 0 0 0]{./image/hardware_photo_1.png}
% \bicaption[1]{图}{\centering 硬件系统实物照片1}{Fig.}{\centering Photograph of the hardware system 1}
% \end{figure}
