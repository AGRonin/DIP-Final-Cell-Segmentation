...
本实验希望实现对细胞图像实现细胞分割，以完成在医学领域的细胞计数工作。本实验以Otsu算法为起点，在观察到存在细胞粘连问题后，引入分水岭算法和U-Net算法进行进一步改善。
\end{CAbstractJBUAA}
%%%%%%%%首页角注
...
\input{section/项目背景与意义}

\input{section/实验数据说明}

\section{模型原理}

\input{section/Otsu算法讲解}

\input{section/分水岭算法讲解}

\input{section/U-Net模型讲解}

\section{项目主要工作与解决方法}

\input{section/项目主要工作与解决方法1}

\input{section/项目主要工作与解决方法2}

\input{section/实验结果展示及分析}
...
\bibitem{otsu}
邓子青,王阳,张兵,等.基于Otsu算法与形态学的火龙果图像分割研究[J].智能计算机与应用,2022,12(06):106-109+115.

\bibitem{watershed}
游迎荣,范影乐,庞全.基于距离变换的粘连细胞分割方法[J].计算机工程与应用,2005,(20):206-208.

\bibitem{unet}
Ronneberger, O., Fischer, P., \& Brox, T. (2015). U-Net: Convolutional Networks for Biomedical Image Segmentation. MICCAI 2015, 234-241. Springer, Cham. DOI: 10.1007/978-3-319-24574-4\_28
